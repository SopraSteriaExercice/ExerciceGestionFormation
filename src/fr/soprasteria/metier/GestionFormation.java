...
public class GestionFormation {
	...
	public void moyenne(Formation f){
		...
		System.out.println("La moyenne d'�ge des stagiaires de la formation '"+f.getNom()+"' est de "+moyenne+" ans");
	}
	...
	public Formation saisieFormation(){
		...
		Util.afficher("Ok, la formation '"+f.getNom()+"' qui d�bute le "+formater.format(date)+" a bien �t� enregistr�e");
		//Util.afficher("");
		return f;
	}
